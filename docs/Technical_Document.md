...
## NFTContractV01 Overview Technical

Each NFTContractV01 represent a standard to create an NFT. We inherited NonFungibleToken to conform our standard with the existent NFT standard.
